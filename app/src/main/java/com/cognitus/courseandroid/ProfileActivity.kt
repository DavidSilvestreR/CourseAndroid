...
import com.cognitus.courseandroid.databinding.ActivityProfileBinding
...
class ProfileActivity : Utility(), View.OnClickListener  {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initializeToolbar(binding.barraP, "Perfil", true,false)
        revisaPermiso()
    ...
    override fun onRequestPermissionsResult(
        ...
        when (requestCode) {
            REQUEST_INTERNET -> if (grantResults.size > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                Log.i("CAMARA", "Si dio permiso")
            } else {
                Log.i("CAMARA", "No dio permiso")
            }
        }
    }
